...
const input = (0, tools_ts_1.readFileInputRegex)('inputs/day11.txt', '\r\n\r\n');
class Monkey {
    constructor(input) {
        this.nbInspectedItems = 0;
...
console.log('Part 1', monkeyList
    .sort((m1, m2) => m2.nbInspectedItems - m1.nbInspectedItems)
    .slice(0, 2)
    .reduce((agg, c) => agg * c.nbInspectedItems, 1)); // 90882
